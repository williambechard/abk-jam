...
public class LevelManager : MonoBehaviour
{
    ...
    public void LoadScene(string sceneName)
    {
        ...
        lScene(UnityEngine.SceneManagement.SceneManager.LoadSceneAsync(sceneName));
    }
    ...
    public void LoadSceneAdditive(string sceneName)
    {
        ...
        lastLoadedScene = sceneName;
        lScene(UnityEngine.SceneManagement.SceneManager.LoadSceneAsync(sceneName, UnityEngine.SceneManagement.LoadSceneMode.Additive));
    }
